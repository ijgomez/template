...
Bienvenido a la documentación del proyecto **Template**.

En este directorio se encuentra toda la documentación funcional y técnica de la plantilla. Aquí se describen la arquitectura, las funcionalidades, las decisiones de diseño, las guías de desarrollo y la especificación funcional que sirven como referencia para la creación de nuevas aplicaciones basadas en esta plataforma.
...
- [Layout](03-technical/frontend/layout.md)
...
- [Liquibase](03-technical/backend/liquibase.md)
...
Documentación funcional completa del sistema.

- [Visión general]()
- [Glosario](specification/glossary.md)
- [Requisitos](specification/requirements.md)
- [Casos de uso](specification/use-cases.md)
