...
El backend expone diferentes tipos de API dependiendo del consumidor.
...
Una de las características principales de Template es la separación entre las API destinadas a la interfaz de usuario y aquellas orientadas a la integración con terceros.
...
Las API de integración permiten la comunicación con aplicaciones externas.
...
Estas API constituyen contratos estables orientados a otros sistemas y evolucionan de forma independiente de la Frontend API.
...
- Mantenibilidad.
- Extensibilidad.
- Evolución independiente de las API.
...
La separación entre la **Frontend API**, destinada exclusivamente a la aplicación Angular, y las **API de Integración**, orientadas a sistemas externos, permite optimizar cada interfaz para su consumidor sin duplicar la lógica de negocio.
