...
export class ProfileService {
  ...
  /**
   * Retrieves the full list of profiles matching the given filters, ignoring UI pagination.
   * Used for exports so the exported file reflects all filtered rows, not just the current page.
   */
  findAllByCriteria(criteria: ProfileCriteria, sort?: string): Observable<Profile[]> {
